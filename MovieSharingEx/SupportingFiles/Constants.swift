...
struct Constants {
    ...
    struct Storage {
        ...
        static var favoriteDataList =
            Global.favoriteList(from: UserDefaults.standard.value(forKey: idKey)) {
            didSet {
                Global.encodeMoviesData(favoriteDataList, andSaveToStorageWithKey: idKey)
            }
        }
